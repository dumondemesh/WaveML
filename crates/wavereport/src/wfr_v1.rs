...
#[derive(Debug, Serialize, Deserialize, Clone, Default)]
pub struct Phase { pub c_phi: Option<f64>, pub h1: Option<f64> }

#[derive(Debug, Serialize, Deserialize, Clone, Default)]
pub struct Swap { pub epsilon_budget: Option<f64>, pub swaps: u32, pub accepted: u32, pub rejected: u32 }

#[derive(Debug, Serialize, Deserialize, Clone)]
pub struct WParams {
    pub n_fft: u32, pub hop: u32, pub window: String, pub center: bool, pub pad_mode: String, pub mode: String
}
#[derive(Debug, Serialize, Deserialize, Clone)]
pub struct WPerf {
    pub backend: String, pub backend_version: String, pub wall_ms: f64, pub frames: u64, pub threads: Option<u32>
}
#[derive(Debug, Serialize, Deserialize, Clone, Default)]
pub struct Metrics { pub mse: Option<f64>, pub rel_mse: Option<f64>, pub snr_db: Option<f64>, pub cola_max_dev: Option<f64> }

#[derive(Debug, Serialize, Deserialize, Clone)]
pub struct LogEvent {
    pub ts: String, pub level: String, pub span: Option<String>, pub msg: String, pub kv: Option<serde_json::Value>,
}
...
impl WfrV1 {
    pub fn new(schema_version: &str, run_id: &str, cert: Cert, w_params: WParams, w_perf: WPerf) -> Self {
        ...
        Self {
            ...
            created_at, run_id: run_id.to_owned(),
            cert, mdl: None, phase: None, swap: None,
            w_params, w_perf,
            metrics: Metrics::default(), log: Some(Vec::new()),
        }
    }
}
